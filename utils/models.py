...
class MatchReport():
    """ Holds match report data generated by Match """
    def __init__(self, row):
        ...
        self.civ_1 = c['civ'][int(c1)]
        self.civ_2 = c['civ'][int(c2)]
        self.map = c['map_type'][int(m)]

    def all(report_type):
        reports = []
        with open('{}/data/match_{}_data.csv'.format(ROOT_DIR, report_type)) as f:
            reader = csv.reader(f)
            for row in reader:
